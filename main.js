  ...
  playGame() {
    ...
    while (
      ...
      const direction = prompt(
        "Which direction would you like to move? Please ennter N for North, S for  South, E for East, or W for West. \n"
      );

      if (direction.toUpperCase() === "N") {
        if (y === 0) {
          console.log(
            "You cannot move any further North. Please choose another direction"
          );
        } else {
          y -= 1;
        }
        ...
        if (y >= this._field.length) {
          console.log(
            "You cannot move any further South. Please choose another direction"
          );
        } else {
          y += 1;
        }
        ...
        if (x === 0) {
          console.log(
            "You cannot move any further West. Please choose another direction"
          );
        } else {
          x -= 1;
        }
        ...
        if (x >= this._field[y].length) {
          console.log(
            "You cannot move any further East. Please choose another direction"
          );
        } else {
          x += 1;
        }
